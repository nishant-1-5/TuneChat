...
//Not checked for errors Do after building player
...
const AlbumPage = () => {
    ...
    // console.log(currentAlbum); // remove later
            ...
            <div className="relative min-h-full">
                ...
                <div
					 ...
					 to-zinc-900 pointer-events-none'
						aria-hidden='true'/>
					{/* TODO:: MAKE THE GRADIENT DYNAMIC BY USING THE ALBUM IMAGE and finding the max color(?) and then using that color */}
                    {/* Content */}
                                        ...
                                        <div key={song._id} onClick={() => handlePlaySong(index)}
                                         ...
                                         text-zinc-400 hover:bg-white/5 rounded-md group cursor-pointer`}>
                                                ...
                                                {isCurrent && isPlaying ?
                                                 (
                                                    <div className="size-4">
                                                        <CiMusicNote1 className="text-emerald-500"/>
                                                    </div>
                                                 )
                                                    :(
                                            ...
                                            <div className="flex items-center gap-3">
                                                <img src={song.imageUrl} alt={song.title} className="size-5"/>
                                                <div>{song.artist}</div>
                                            </div>
